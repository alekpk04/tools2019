...
echo $red"            harap sabar menunggu yaa gaesss :v("   
sleep 1
echo '''\a
\033[34;1m                              _
\033[34;1m                             / |
...
echo
echo $pur"==================="$cy" ============================="
echo $i"Ôûê"$pu"  AUTHOR  :  Lee KPK  "$i"                    Ôûê"
echo $i"Ôûê"$pu"  WhatsApp:  083824119xxx"$i"                Ôûê"
echo $i"Ôûê"$pu"  Github   :  https://github.com/alekpk"$i"     Ôûê"
echo $i"Ôûê"$pu"  ID LINE :  alinur88"$i"                 Ôûê"
echo $pur"==================="$cy" ============================="
echo
echo $cy"BRUTTEFORCE 2019:"
...
sleep 2
echo $pur"GA usah sombong…ingat di atas langit masih ada langit"
sleep 2
echo $ku
echo $ku
echo $ku
...
sleep 2
echo $pur"SEE YOU FOR JIWA JIWA YANG TERLENA,THANKS FOR ALL BY MARKAS SINGO KPK"
exit
fi
